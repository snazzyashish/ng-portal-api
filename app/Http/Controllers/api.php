...
Route::get('/file/list', [FileUploadController::class, 'list']);
Route::post('/file/save', [FileUploadController::class, 'Upload']);
Route::post('/file/delete', [FileUploadController::class, 'delete']);
